    ...
    const handleLoginClick = async () => {
        ...
        try {
            ...
            if (result.user && result.user.role === 'admin') {
                console.log("User is admin, proceeding with login"); // Debug log
                ...
                navigate('/list-songs', { replace: true }); // Using replace: true to prevent back navigation
            } else {
                console.log("User is not admin, role:", result.user?.role); // Debug log
